...
function Nav() {
  ...
  const menus = [
    ...
    { id: 3, menu: '제품소개', sub1: '제품01', sub2: '제품02', sub3: '제품03', sub4: '제품04' },
    { id: 4, menu: '커뮤니티', sub1: '고객상담', sub2: '공지사항', sub3: '문의게시판', sub4: 'FAQ' },
    { id: 5, menu: '고객센터', sub1: '갤러리', sub2: '매장안내', sub3: '이벤트' },
  ];
